...
# rests on, and until now they existed in exactly ONE place: /aidata on ubuntuai
# — a VM on pve840, the node with the known failing DIMM. A host loss would not
...
DEST_HOST="${ALPHA_GATE_BACKUP_HOST:-dunkin@192.168.0.25}"
DEST_DIR="${ALPHA_GATE_BACKUP_DIR:-/volume1/homes/dunkin/claude-sync/alpha-gate-bars}"
VERIFY_ONLY=0
